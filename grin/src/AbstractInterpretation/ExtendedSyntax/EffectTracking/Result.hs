...
module AbstractInterpretation.ExtendedSyntax.EffectTracking.Result where
...
import Grin.ExtendedSyntax.Grin (Name, Tag, External(..))
...
import AbstractInterpretation.ExtendedSyntax.EffectTracking.CodeGenBase (ETMapping(..))

...
module Transformations.ExtendedSyntax.Optimising.InterproceduralDeadFunctionElimination where
...
interproceduralDeadFunctionElimination :: LVAResult -> TypeEnv -> Exp -> Either String Exp
interproceduralDeadFunctionElimination lvaResult tyEnv = runTrf .

...
module Transformations.ExtendedSyntax.Optimising.InterproceduralDeadParameterElimination where
...
interproceduralDeadParameterElimination :: LVAResult -> TypeEnv -> Exp -> Either String Exp
interproceduralDeadParameterElimination lvaResult tyEnv = runTrf . cataM alg where

(module
  ...
  (func $grinMain (type 1)
    ...
    get_local 3
    get_local 6
    i32.store offset=65536 align=1
    i32.const 1
    set_local 7
    get_local 4
    get_local 7
    ...
    set_global 0
    return)
  (func $.Leval (type 2) (param i32 i32)
    ...
    call $_prim_int_print
    unreachable)
  (func $.Lupto (type 3) (param i32 i32 i32)
    ...
    call $_prim_int_print
    unreachable)
  (func $.Lsum (type 2) (param i32 i32)
